...
They can vastly improve comprehension by using graphics to harness the human visual system’s ability to see patterns and trends. \autocite{heer2010tour, sears2007human}
...
HTML was originally designed as a markup language for communicating static pages that contain text and limited amounts of media, while using CSS for styling.
...
However, JavaScript was originally intended for simple scripts which manipulate the DOM (Document Object Model, the browser's in-memory presentation of the loaded page), and this legacy has lead to challenges in scaling increasingly complex JavaScript applications.
...
Another benefit in the Graphene example is two-way data binding, which allows the view to be updated when the data changes.
