...
%
\Title{Carbon: A Collaborative Modeling Environment for Computational Systems Biology}
\Author{Stanley Gu}
\Year{2014}
...
\setcounter{page}{-1}
\abstract{%
  Science relies on a process of verifying, learning from, and extending each other's results.
  In Computational Systems Biology, software, standards, and ontologies have been developed to overcome these challenges.
  This dissertation work is concerned with developing a relatively untapped field of software for Systems Biology, web development.
  Graphene framework was developed to overcome technical challenges in building visual and interactive scientific web development.
  Demonstrating its usefulness, Graphene was integrated into an existing regulatory network inference web-tool, TiDAL, and also used to a develop a brand new application for pathway data exploration, Redox.
  Building off these applications, the culminating project of this work is Carbon, a collaborative modeling framework.
}
