...
\abstract{%
  ...
  In Computational Systems Biology, software, standards, and ontologies have been developed to help faciliate this process.
  ...
  Demonstrating its usefulness, Graphene was integrated into an existing regulatory network inference web-tool, TiDAL, and also used to a develop a novel application for pathway data exploration, Redox.
